...
!set xr[:200]
plot \
     "dr_nu_pos.dat" u 1:2   w p ps 1 pt 6 lc 7 title "{/Symbol w}_r(Eq.(61))",\
     "dr_nu_pos.dat" u 1:3  w p ps 1 title "{/Symbol g}(Eq.(61))",\
     "dr_nu_pos.dat" u 1:4 w l lw 2 lc 0 title "{/Symbol w}_r(Eq.(65))",\
     "dr_nu_pos.dat" u 1:5 w l lw 2 lc 7 title "{/Symbol g}(Eq.(64))",\
