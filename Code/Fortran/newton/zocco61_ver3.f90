...
!     Dprim=-2*sqrt(ky*ls*ky*ls-1)/ls
 ...
 !    print *,'xi=',xi
     ...
     u1=1./6*(27*xi-1+3*sqrt(3*(27*xi-2)*xi))**(1./3)
     v1=1./6*(27*xi-1-3*sqrt(3*(27*xi-2)*xi))**(1./3)
...
!     write(30,'(7f25.5)')nu_e/omega_t,real(omega_new),imag(omega_new),real(omega_ex1),imag(omega_ex1),real(omega_ex2),imag(omega_ex2),real(omega_ex3),imag(omega_ex3)
